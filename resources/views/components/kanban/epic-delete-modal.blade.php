...
<div class="fixed inset-0 overflow-y-auto modal-backdrop" style="z-index: 10000;">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm" wire:click="$set('showDeleteEpicModal', false)"></div>
        ...
        <div class="relative bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-700/50 modal-content">
            ...
            <h3 class="text-2xl font-bold text-white text-center mb-2">Supprimer l'epic</h3>
            <p class="text-gray-400 text-center mb-6">
                Êtes-vous sûr de vouloir supprimer l'epic "<span class="font-bold text-white">{{ $epic->name }}</span>" ? Cette action est irréversible.
            </p>

            <div class="flex gap-3">
                <button type="button" wire:click="$set('showDeleteEpicModal', false)"
                        class="flex-1 px-6 py-2 bg-gray-700 text-white rounded-full hover:bg-gray-600">
                    Annuler
                </button>
                <button type="button" wire:click="deleteEpic"
