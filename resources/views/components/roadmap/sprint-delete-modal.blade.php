...
<div class="fixed inset-0 overflow-y-auto modal-backdrop" style="z-index: 10000;">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm" wire:click="$set('showDeleteSprintModal', false)"></div>
        ...
        <div class="relative bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-700/50 modal-content">
            ...
            <h3 class="text-2xl font-bold text-white text-center mb-2">Supprimer le sprint</h3>
            <p class="text-gray-400 text-center mb-6">
                Êtes-vous sûr de vouloir supprimer le sprint "<span class="font-bold text-white">{{ $sprint->name }}</span>" ? Cette action est irréversible.
            </p>

            <div class="flex gap-3">
                <button type="button" wire:click="$set('showDeleteSprintModal', false)"
